...
A：这取决于排名百分比，但有一些学校也会参考简历进行筛查。可参考往届同排名水平学长学姐的去向，但不要被百分比限制，水平不超出太多的学校都可以尝试投递。弱COM学校也可以通过联系导师入营。目前已知最低rk的外推情况，23年中山大学的预推免有rk15%的同学入营。
...
A：不是绝对的。这与学校政策和导师有关。首先科研与就业不完全冲突，有一些研究方向本身就是要将新的方法应用到实际当中，其次如果导师分配很多横向或不放实习(一些质量不高的横向对于就业没有帮助)，则不利于就业；如果导师既能提供好的帮助或放实习，或者与企业有强connection，则有利于就业。随着专硕名额扩大，学硕缩减，是否有利于就业可能更与导师有关。但部分院校的专硕就是面向就业的，例如人大等，这些学校选择专硕能得到的实习机会更多。
...
A：概况可通过[研控](https://www.yankong.org/)，询问该校同学了解。学术水平查询google scholar等。考虑的一些方面有：研究方向，学术水平，导师是否在科研一线，往届学生去向，实验室氛围是否符合自己预期等。
